...
export const INTRO_CARDS = [
  {
    ...
    "note": "Ten clauses the source material identifies as essential to a residential lease. Use them as a checklist while you read the pages that follow.",
    "items": [
      [
        "Parties",
...
export const SUMMARY = [
  {
    ...
    "items": [
      [
        "Lease term",
        "Begins September 10, 2026 and ends at 11:59 p.m. on September 30, 2027 (¶3)."
      ],
      [
        "Automatic renewal",
        "Renews month-to-month unless either party gives at least 60 days written notice. If the notice-days blank is not filled in, ¶3 requires at least 30 days."
      ],
      [
        "Rent due date",
        "The 1st of each month, with no grace period (¶6)."
      ],
      [
        "Late charge trigger",
        "Rent unpaid after the 3rd day of the month draws a late charge (¶6)."
      ],
      [
        "First month prorated",
        "$1,172.50 for September 10–30, 2026, due September 10, 2026 (¶6)."
      ]
    ]
  },
  {
    ...
    "items": [
      [
        "Monthly rent",
        "$1,675.00, payable in advance and without demand (¶6)."
      ],
      [
        "Security deposit",
        "$500.00, due on or before signing, held at Peachtree State Bank & Trust (¶4). If interest is earned on the deposit, ¶4 states the owner may keep it."
      ],
      [
        "Late charge",
        "10% of total monthly rent; ¶6 states late charges shall not exceed ten percent of the monthly rent payment."
      ],
      [
        "Returned payment",
        "$50.00 per returned check or rejected electronic payment, plus a late charge (¶6)."
      ],
      [
        "Reletting charge",
        "$1,675.00, capped by ¶11 at 100% of the highest monthly rent during the term. ¶11 states it is not a cancellation or buyout fee and does not release you from the lease."
      ],
      [
        "Utilities",
        "No owner-paid utility boxes are checked on page 1, so ¶7 leaves all listed utilities, related deposits and charges to the resident."
      ],
      [
        "All payments are rent",
        "¶6 states all payment obligations under the lease constitute rent."
      ]
    ]
  },
  {
    ...
    "items": [
      [
        "Move-out notice",
        "Must be in writing and must state the date you intend to vacate (¶46), given as far in advance as ¶3 requires — 60 days under this lease."
      ],
      [
        "Where notice goes",
        "¶37 states written notice to or from managers constitutes notice to or from the owner. Page 9 (¶54) carries the name and address to use."
      ],
      [
        "Keep a copy",
        "¶37 states any person giving notice under the lease should retain a copy."
      ],
      [
        "Repair requests",
        "¶27 requires requests through the online resident/maintenance portal, or signed and in writing to the designated representative, except for the emergencies it lists. Notes taken on an oral request do not count as a written request."
      ],
      [
        "Forwarding address",
        "¶47 requires giving the owner and the U.S. Postal Service each resident's forwarding address in writing; ¶51 requires written notice of it on or before termination."
      ]
    ]
  },
  {
    ...
    "items": [
      [
        ...
        "¶47 states it cannot be changed unless both parties agree in writing."
      ],
      [
        "Deposit cannot be used as rent",
        "¶47 states the resident is prohibited by law from applying the security deposit to rent."
      ],
      [
        "Everyone must be out",
        "¶47 states all residents, guests and occupants must vacate before the 30-day deposit refund period begins."
      ],
      [
        "Cleaning",
        "¶48 lists the areas to be cleaned and states that inadequate cleaning creates liability for reasonable cleaning charges."
      ],
      [
        "Inspection and damage list",
        "¶49 describes the inspection window, your right to request and inspect the damage list, and the effect of signing or not objecting to it."
      ],
      [
      ...
      [
        "Deposit return",
        "¶51 requires written notice of a forwarding address on or before termination; the refund and an itemized accounting are mailed to that address."
      ]
    ]
  }
];
    ...
    "hotspots": [
      {
        ...
        "definition": "The names of the residents signing the lease.",
        ...
        "importantToKnow": "¶1 notes that if anyone has guaranteed performance of the lease, a separate Lease Contract Guaranty is attached. A guarantor is a third party who is legally responsible for the financial obligations under the lease if the resident fails to pay rent or other money owed.",
      ...
      },
      {
        ...
        "whyItMatters": "Anyone not listed is a guest, and ¶2 sets a limit on how long guests may stay.",
      ...
      },
      {
        ...
        "importantToKnow": "¶3 states that if the notice-days blank is not filled in, at least 30 days notice is required.",
      ...
      },
      {
        ...
        "whyItMatters": "¶4 makes the deposit due on or before signing, and it is the fund that move-out charges are measured against.",
        "example": "$500.00, held at Peachtree State Bank & Trust.",
        "importantToKnow": "¶4 states that if interest is earned on the deposit, the owner may keep it.",
      ...
      },
      {
        ...
        "meaning": "¶5 records the keys, mailbox keys, FOBs and other access devices provided at move-in, and states that the resident is responsible for replacement or repair costs if a device is lost, damaged, or not returned.",
      ...
      },
      {
        ...
        "whyItMatters": "¶6 sets the due date as the 1st of each month with no grace period, and states that all payment obligations under the lease constitute rent.",
        ...
        "importantToKnow": "The typed Special Provision on page 2 states that the landlord reserves the right to reject any partial rent payment.",
        "crossRef": [
          {
            "page": 2,
            "hotspot": "special-provisions",
            "label": "Special Provisions (¶10), page 2"
          }
        ],
      ...
      },
      {
        ...
        "whyItMatters": "¶7 states the resident pays for all other utilities, related deposits and charges.",
    ...
    "hotspots": [
      {
        ...
        "meaning": "¶7 continued restricts disconnecting utilities before the term ends, and includes a disclosure about management selecting the resident’s natural gas marketer.",
      ...
      },
      {
        ...
        "meaning": "¶8 states that the owner does not insure the resident’s personal property or personal injury, urges renter’s insurance, and contains the personal liability insurance election. In this lease the “required to purchase personal liability insurance” box is checked.",
        "importantToKnow": "¶8 describes failure to maintain required personal liability insurance as an incurable breach of the lease.",
      ...
      },
      {
        ...
        "meaning": "¶9 covers rekeying before move-in, the prohibition on installing additional locks without written consent, and who pays for later rekey requests and for repairs arising from misuse.",
      ...
      },
      {
        ...
        "whyItMatters": "¶10 states that these provisions become part of the lease and supersede conflicting provisions of the printed form.",
        "example": "This lease adds one special provision: the landlord reserves the right to reject any partial rent payment.",
        "importantToKnow": "¶10 directs the reader to any additional special provisions, and the form continues them on page 9.",
        "crossRef": [
          {
            "page": 9,
      ...
      },
      {
        ...
        "leaseLanguage": "You’ll be liable to us for a reletting charge of $1,675.00 (not to exceed 100% of the highest monthly rent during the Lease Contract term) if you: (1) fail to give written move-out notice as required in paragraphs 24 (Military Transfer and Lease Termination) or 46 (Move-Out Notice); or (2) move out without paying rent in full for the entire Lease Contract term or renewal period; or (3) move out at our demand because of your default; or (4) are judicially evicted. … **Not a Release.** The reletting charge is not a Lease Contract cancellation fee or buyout fee.",
        "meaning": "A charge that applies in the four situations ¶11 lists, including moving out without paying rent for the full term and being judicially evicted.",
        "whyItMatters": "¶11 states the reletting charge is not a cancellation or buyout fee and does not release the resident from the lease.",
        "example": "The reletting charge is $1,675.00, which ¶11 caps at 100% of the highest monthly rent during the term.",
        "importantToKnow": "¶11 states that if no amount is stipulated, the resident must pay the actual reletting costs so far as they can be determined.",
      ...
      },
      {
        ...
        "whyItMatters": "¶13 defines which spaces count for this purpose — it excludes common areas but includes interior living areas, patios, balconies, attached garages, and exclusive-use storerooms.",
    ...
    "hotspots": [
      {
        ...
        "meaning": "¶13 continued covers storage of property after eviction, surrender or abandonment; how stored property may be redeemed; and the notice requirements before any sale.",
      ...
      },
      {
        ...
        "meaning": "¶14 addresses what may happen if the first month’s rent is not paid when or before the lease begins.",
      ...
      },
      {
        ...
        "meaning": "Rent and terms generally cannot change before the initial term ends, except through the routes ¶15 lists.",
        "whyItMatters": "¶15 describes how a month-to-month continuation can carry increased rent if proper written notice is given. This connects to the renewal language in ¶3.",
        "importantToKnow": "¶15 states the modified lease can begin without the resident’s signature unless written move-out notice is given under ¶46.",
      ...
      },
      {
        ...
        "meaning": "¶16 covers what happens if move-in is delayed, including rent abatement during the delay and specific windows in which the resident may terminate depending on when notice is given.",
      ...
      },
      {
        ...
        "leaseLanguage": "Unless otherwise prohibited by law, if, during the term of this Agreement, any locality, city, state, or Federal Government imposes upon Us, any fee, charge, or tax, which is related to or charged by the number of occupants, or by the apartment itself, such that we are charged a fee, charge, or tax, based upon your use or occupancy of the apartment, we may add this charge as Additional Rent, during the term of the Lease Contract, with thirty (30) days advance written notice to you.",
        "meaning": "¶17 describes government-imposed fees, charges or taxes tied to occupancy that may be added as Additional Rent with 30 days advance written notice.",
      ...
      },
      {
        ...
        "meaning": "Written community rules are part of the lease, and ¶20 sets expectations for cleanliness, passageways, amenity use and permitted activity.",
        ...
        "whyItMatters": "¶20 addresses permitted use of the apartment, including the limits on conducting business from the premises. ¶19 states rules may be reasonably changed but cannot change the dollar amounts on page 1.",
    ...
    "hotspots": [
      {
        ...
        "meaning": "¶21 lists activities that residents, occupants and guests may not engage in.",
      ...
      },
      {
        ...
        "whyItMatters": "¶22 states that unauthorized vehicles may be removed at the resident’s expense.",
      ...
      },
      {
        ...
        "whyItMatters": "¶23 lists specific circumstances that do not release a resident, including job transfer, marriage, separation, divorce, loss of co-residents, loss of employment, bad health, and death.",
        "importantToKnow": "¶23 sets out a separate route for termination based on a family violence court order, with its own notice requirements.",
        "crossRef": [
          {
            "page": 5,
            "hotspot": "when-we-may-enter",
            "label": "When We May Enter (¶29), page 5"
          }
        ],
      ...
      },
      {
        ...
        "meaning": "¶24 sets out an early-termination right for service members who meet one of six listed conditions, with notice and documentation requirements.",
      ...
      },
      {
        ...
        "meaning": "¶25 covers detector testing and battery replacement responsibilities, the prohibition on disabling detectors, and the liability stated for damaging or disabling them.",
    ...
    "hotspots": [
      {
        ...
        "meaning": "¶25 continued directs residents to call 911 first and then the owner’s representative, addresses the owner’s position on security measures, and describes the resident’s reporting obligation after a crime.",
      ...
      },
      {
        ...
        "whyItMatters": "¶26 states that otherwise everything is considered to be in clean, safe and good working condition. This connects directly to move-out charges under ¶50.",
        "crossRef": [
          {
            "page": 8,
            "hotspot": "deposit-deductions",
            "label": "Security Deposit Deductions (¶50), page 8"
          }
        ],
      ...
      },
      {
        ...
        "whyItMatters": "¶27 requires requests through the online resident/maintenance portal, or signed and in writing to the designated representative, except for the emergencies it lists. It also states that notes taken on an oral request do not count as a written request.",
        "importantToKnow": "¶27 states that air conditioning problems are not treated as emergencies.",
      ...
      },
      {
        ...
        "meaning": "¶28 states that no animals are allowed anywhere in the apartment or community without written authorization.",
        "whyItMatters": "The supplied material notes that for pets there may be an additional Pet Addendum to reference.",
        "importantToKnow": "¶28 states that deposits, additional rents, fees or other charges are not required for an assistance animal needed due to disability, including an emotional support or service animal, as authorized under applicable law.",
      ...
      },
      {
        ...
        "whyItMatters": "¶29 states that when nobody is present, written notice of the entry must be left in a conspicuous place immediately afterward, and that entry must be for one of the listed purposes.",
        "importantToKnow": "¶29 is the paragraph referenced as “I3500” in the supplied glossary under Release of Resident, confirmed as point 29 on page 5.",
    ...
    "hotspots": [
      {
        ...
        "whyItMatters": "¶30 states that if any resident, occupant or guest violates the lease, all residents are considered to have violated it, and that notice to one resident counts as notice to all. The supplied material frames this as: any violation by a guest falls under the responsibility of the resident.",
      ...
      },
      {
        ...
        "leaseLanguage": "Replacing a resident, subletting, assignment, or granting a right or license to occupy is allowed only when we expressly consent in writing. If departing or remaining residents find a replacement resident acceptable to us before moving out and we expressly consent, in writing, to the replacement, subletting, assignment, or granting a right or any license to occupy, then: (1) a reletting charge will not be due; (2) a reasonable administrative (paperwork) and/or transfer fee will be due, and a rekeying fee will be due if rekeying is requested or required; and (3) the departing and remaining residents will remain liable for all lease obligations for the rest of the original lease term. … The departing resident will no longer have a right to occupancy or a security deposit refund, but will remain liable for the remainder of the original Lease Contract term unless we agree otherwise in writing — even if a new Lease Contract is signed.",
        ...
        "whyItMatters": "¶31(3) states that the departing and remaining residents remain liable for all lease obligations for the rest of the original lease term, and the Procedures for Replacement paragraph repeats that the departing resident remains liable even if a new Lease Contract is signed.",
      ...
      },
      {
        ...
        "whyItMatters": "¶32 sets out a specific sequence a resident must follow before terminating for a repair issue, including a written request, rent being current, a reasonable time to repair, and a written notice of intent to terminate.",
      ...
      },
      {
        ...
        "leaseLanguage": "You’ll be in default if you or any guest or occupant violates any terms of this Lease Contract including but not limited to the following violations: (1) you don’t pay rent or other amounts that you owe when due; … **Eviction.** If you default, we may end your right of occupancy by giving you a 24-hour written notice to vacate. We will provide a three (3) day notice for an eviction action due to nonpayment of rent. … Termination of your possession rights or subsequent reletting doesn’t release you from liability for future rent or other lease obligations.",
        "meaning": "The nine categories of default that ¶33 lists, and the notices described for ending the right of occupancy.",
        ...
        "whyItMatters": "¶33 states that termination of possession rights or subsequent reletting does not release the resident from liability for future rent or other lease obligations.",
        "source": "WIL: Eviction | Lease ¶33 — flagged",
        "needsContent": false,
        "contentFlag": "ambiguous",
        "flagNote": "The supplied glossary describes eviction as the process that terminates the lease early. Lease ¶33 describes the right of possession ending while liability for future rent continues. Confirm how you want this framed for residents.",
        "rects": [
          {
            "x": 4.47,
            "y": 74.32,
      ...
      },
      {
        ...
        "meaning": "¶33 describes what applies when a resident stays past the move-out date, and separately describes the owner’s commitment to exercise customary diligence to relet and to credit subsequent rent received.",
    ...
    "hotspots": [
      {
        ...
        "whyItMatters": "¶34 states the written lease is the entire agreement and that no oral promises were made. ¶35 states representatives have no authority to waive, amend or terminate the lease except in writing.",
      ...
      },
      {
        ...
        "whyItMatters": "¶37 states that written notice to or from managers constitutes notice to or from the owner, and that anyone giving notice should retain a copy.",
        "crossRef": [
          {
            "page": 9,
            "hotspot": "disclosure-notice",
            "label": "Who to contact (¶54), page 9"
          }
        ],
      ...
      },
      {
        ...
        "meaning": "¶42 states that once a notice to vacate is given and accepted, the resident must vacate and remove all personal property at expiration of the term without further notice.",
      ...
      },
      {
        ...
        "meaning": "¶44 states that payment of all sums is an independent covenant, and describes how money received may be applied to unpaid obligations before current rent, regardless of notations on the payment.",
      ...
      },
      {
        ...
        "whyItMatters": "¶46 states all notices to vacate must be in writing and must state the intended move-out date, and describes the consequences when notice does not meet the timing requirements in ¶3.",
        "example": "Under this lease, 60 days written notice is required (¶3).",
    ...
    "hotspots": [
      {
        ...
        "whyItMatters": "¶47 states that the move-out date cannot be changed unless both parties agree in writing, that the resident is prohibited by law from applying the security deposit to rent, and that all residents, guests and occupants must vacate before the 30-day deposit refund period begins.",
        "importantToKnow": "¶47 requires giving the owner and the U.S. Postal Service each resident’s forwarding address in writing.",
      ...
      },
      {
        ...
        "whyItMatters": "¶48 lists the areas to be cleaned and states that inadequate cleaning creates liability for reasonable cleaning charges.",
      ...
      },
      {
        ...
        "whyItMatters": "¶49 describes the resident’s right to request and inspect the damage list within the stated window, and the effect of signing or of not objecting to the list.",
        "source": "WIL: Move-out Inspection, FAS | Lease ¶49 — flagged",
        "needsContent": false,
        "contentFlag": "ambiguous",
        "flagNote": "The supplied material says the inspection occurs “three (3) days” after move-out and describes a Service Manager taking pictures. Lease ¶49 says “within 3 business days” and does not name a role. Confirm which wording to display.",
        "rects": [
          {
            "x": 4.47,
            "y": 18.54,
      ...
      },
      {
        ...
        "whyItMatters": "¶50 lists specific categories including unpaid rent and utilities, damage from negligence or unapproved holes, unreturned keys, and animal-related charges. This connects back to the Inventory and Condition form in ¶26.",
        "crossRef": [
          {
            "page": 5,
            "hotspot": "condition-alterations",
            "label": "Inventory and Condition form (¶26), page 5"
          }
        ],
      ...
      },
      {
        ...
        "whyItMatters": "¶51 requires the resident to provide written notice of a forwarding address on or before termination of the lease, and states that the refund and an itemized accounting are mailed to that address.",
      ...
      },
      {
        ...
        "leaseLanguage": "**Surrender.** You have surrendered the apartment when: (1) the move-out date has passed and no one is living in the apartment in our reasonable judgment; or (2) all apartment keys and access devices listed in paragraph 5 (Keys) have been turned in where rent is paid — whichever date occurs first. **Abandonment.** You have abandoned the apartment when all of the following have occurred: (1) everyone appears to have moved out with the intention to give up all rights to occupy or use the apartment in our reasonable judgment; (2) you’ve been in default for non-payment of rent for 5 consecutive days …; and (3) you’ve not responded for 2 days to our notice left on the inside of the main entry door, stating that we consider the apartment abandoned.",
        "meaning": "¶51 defines when the apartment is considered surrendered, and the conditions that must all occur for it to be considered abandoned.",
    ...
    "hotspots": [
      {
        ...
        "whyItMatters": "¶54 is where a resident finds the correct name and address for sending formal notice — the same notices required under ¶27, ¶37 and ¶46.",
      ...
      },
      {
        ...
        "meaning": "¶54 also records the licensed managing agent’s corporate name and license number, as required by Georgia Real Estate Commission rules.",
      ...
      },
      {
        ...
        "importantToKnow": "¶53 states the lease is executed in multiple originals and that a copy or scan may be treated as an original. ¶38(F) states that the omission of initials on any page does not invalidate the lease. Signature lines are intentionally left blank in this educational example.",
